...
export const TOWN_MAP_GRID: TownMapCellData[][] = [
  ...
  [building(), building(), building(), building(), grass(), grass(), grass(), grass(), grass(), building(), building(), building(), building(), road(), road(), road(), road(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), road(), road(), road(), road(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), road(), road(), road(), road(), grass(), grass(), grass(), grass(), building(), building(), building(), building(), building(), building(), grass(), grass(), grass()],
  [building(), building(), building(), building(), grass(), grass(), grass(), grass(), grass(), building(), building(), building(), building(), road(), road(), road(), road(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), road(), road(), road(), road(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), road(), road(), road(), road(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building()],
  [grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), road(), road(), road(), road(), garden(), garden({ id: 'park-tree-3', type: 'tree', label: '公園樹' }), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden({ id: 'park-tree-4', type: 'tree', label: '公園樹' }), garden(), road(), road(), road(), road(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), road(), road(), road(), road(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building()],
  [grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), road(), road(), road(), road(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), road(), road(), road(), road(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), road(), road(), road(), road(), building(), building(), building(), building(), building(), building({ id: 'steak-door-1', type: 'door', label: '牛排館' }), building({ id: 'steak-door-2', type: 'door', label: '牛排館' }), building({ id: 'steak-door-3', type: 'door', label: '牛排館' }), building(), building(), building(), building(), building()],
  ...
  [building(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), building(), building(), road(), road(), road(), road(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), road(), road(), road(), road(), building(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), building(), building(), grass(), grass(), grass(), road(), road(), road(), road(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building()],
  [building(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), building(), building(), road(), road(), road(), road(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), plaza(), road(), road(), road(), road(), building(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), building(), building(), grass(), grass(), grass(), road(), road(), road(), road(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building()],
  [building(), building(), building({ id: 'bakery-door-1', type: 'door', label: '麵包店' }), building({ id: 'bakery-door-2', type: 'door', label: '麵包店' }), building({ id: 'bakery-door-3', type: 'door', label: '麵包店' }), building(), grass(), building(), building(), building({ id: 'ramen-door', type: 'door', label: '拉麵店' }), building(), building(), building(), road(), road(), road(), road(), plaza(), plaza(), plaza(), plaza({ id: 'veggie-stall', type: 'marketStall', label: '蔬菜攤' }), plaza(), plaza(), plaza(), plaza(), plaza({ id: 'meat-stall', type: 'marketStall', label: '肉攤' }), plaza(), plaza(), plaza(), plaza(), plaza({ id: 'fish-stall', type: 'marketStall', label: '魚攤' }), plaza(), plaza(), road(), road(), road(), road(), building(), building(), building(), building({ id: 's-house-1-door', type: 'door', label: '民宅E' }), building(), building(), grass(), building(), building(), building({ id: 's-house-2-door', type: 'door', label: '民宅F' }), building(), building(), building(), grass(), grass(), grass(), road(), road(), road(), road(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building(), building()],
