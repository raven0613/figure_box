...
export const TOWN_MAP_GRID: TownMapCellData[][] = [
  ...
  [grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), grass(), road(), road(), road(), road(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), garden(), road(), road(), road(), road(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), building(), grass(), building(), building(), building(), building(), road(), road(), road(), road(), building(), building(), building(), building(), building(), building({ id: 'town-apartment-door-1', type: 'door', label: '大家的公寓' }), building({ id: 'town-apartment-door-2', type: 'door', label: '大家的公寓' }), building({ id: 'town-apartment-door-3', type: 'door', label: '大家的公寓' }), building(), building(), building(), building(), building()],
