...
export const CHARACTER_SEEDS = [
    { id: 'friend-01', name: 'Tezuka', label: 'T', color: '#413636', position: { x: 18, y: 18 }, saturation: 58 },
    { id: 'friend-02', name: 'Fuji', label: 'F', color: '#e57070', position: { x: 21, y: 18 }, saturation: 32 },
    { id: 'friend-03', name: 'Eiji', label: 'E', color: '#ff9900', position: { x: 24, y: 18 }, saturation: 80 },
    { id: 'friend-04', name: 'Ooishi', label: 'O', color: '#33cc33', position: { x: 27, y: 18 }, saturation: 60 },
    { id: 'friend-05', name: 'Kikumaru', label: 'K', color: '#ff3333', position: { x: 30, y: 18 }, saturation: 90 },
    { id: 'friend-06', name: 'Inui', label: 'I', color: '#333399', position: { x: 18, y: 23 }, saturation: 50 },
    { id: 'friend-07', name: 'Kawamura', label: 'Ka', color: '#996633', position: { x: 21, y: 23 }, saturation: 75 },
    { id: 'friend-08', name: 'Momoshiro', label: 'M', color: '#ff66cc', position: { x: 24, y: 23 }, saturation: 85 },
    ...
    { id: 'friend-11', name: 'Oshitari', label: 'Os', color: '#0066cc', position: { x: 18, y: 28 }, saturation: 55 },
    ...
    { id: 'friend-20', name: 'Yukimura', label: 'Yu', color: '#6699ff', position: { x: 22, y: 14 }, saturation: 80 },
