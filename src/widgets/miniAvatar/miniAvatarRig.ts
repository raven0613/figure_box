...
export const MINI_FRONT_IDLE_RIG_LAYOUT: MiniIdleRigLayout = {
  ...
  bodyByType: {
    1: {
      ...
      armIdleSocketDistance: 4,
      armIdleSocketOffset: { x: 0, y: -6 },
      armIdleLeftSocket: { x: -5, y: -21 },
      armIdleRightSocket: { x: 5, y: -21 },
      legDistance: 5,
      legOffset: { x: 0, y: -2.5 },
    },
    2: {
      ...
      armIdleSocketDistance: 6,
      armIdleSocketOffset: { x: 0, y: -6 },
      armIdleLeftSocket: { x: -5, y: -20.5 },
      armIdleRightSocket: { x: 5, y: -20.5 },
      legDistance: 5,
      legOffset: { x: 0, y: 0.5 },
    },
    3: {
      ...
      armIdleSocketDistance: 6,
      armIdleSocketOffset: { x: 0, y: -6 },
      armIdleLeftSocket: { x: -5, y: -20 },
      armIdleRightSocket: { x: 5, y: -20 },
      legDistance: 5,
      legOffset: { x: 0, y: 3 },
    },
    4: {
      ...
      armIdleSocketDistance: 8,
      armIdleSocketOffset: { x: 0, y: -6 },
      armIdleLeftSocket: { x: -5, y: -19 },
      armIdleRightSocket: { x: 5, y: -19 },
      legDistance: 5,
      legOffset: { x: 0, y: 4.5 },
    },
    5: {
      ...
      armIdleSocketDistance: 8,
      armIdleSocketOffset: { x: 0, y: -6 },
      armIdleLeftSocket: { x: -5, y: -22 },
      armIdleRightSocket: { x: 5, y: -22 },
      legDistance: 5,
      legOffset: { x: 0, y: 6.5 },
    },
  },
...
export const MINI_SIDE_IDLE_RIG_LAYOUT: MiniIdleRigLayout = {
  ...
  bodyByType: {
    1: {
      body: { x: 0, y: -8 },
      bottomAnchor: { x: 0, y: -3 },
      armIdleDistance: 0,
      armIdleOffset: { x: 1, y: -12 },
      armIdleSocketDistance: 0,
      armIdleSocketOffset: { x: 2, y: -12 },
      legDistance: 2,
      legOffset: { x: 1, y: -2.5 },
      rearLegOffset: { x: -4, y: -1 },
    },
    2: {
      body: { x: 0, y: -7.5 },
      bottomAnchor: { x: 0, y: -1 },
      armIdleDistance: 0,
      armIdleOffset: { x: 3, y: -10 },
      armIdleSocketDistance: 0,
      armIdleSocketOffset: { x: 2, y: -10 },
      legDistance: 2,
      legOffset: { x: 1, y: 0.5 },
      rearLegOffset: { x: -4, y: -1 },
    },
    ...
    5: {
      body: { x: 0, y: -6 },
      bottomAnchor: { x: 0, y: 2 },
      armIdleDistance: 0,
      armIdleOffset: { x: 4, y: -8 },
      armIdleSocketDistance: 0,
      armIdleSocketOffset: { x: 2, y: -11 },
      legDistance: 2,
      legOffset: { x: 1, y: 6.5 },
      rearLegOffset: { x: -4, y: -1 },
    },
